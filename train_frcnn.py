...
from frcnn.utils import config, data_generators
...
if options.parser == 'pascal_voc':
    from frcnn.utils.parser_pascal import get_data
elif options.parser == 'simple':
    from frcnn.utils.parser_simple import get_data
else:
...
if options.network == 'vgg':
    C.network = 'vgg'
    from frcnn.cnn import vgg16 as nn
elif options.network == 'resnet50':
    from frcnn.cnn import resnet50 as nn
    C.network = 'resnet50'
elif options.network == 'xception':
    from frcnn.cnn import xception as nn
    C.network = 'xception'
elif options.network == 'inception_resnet':
    from frcnn.cnn import inception_resnet as nn
